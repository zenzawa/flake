{...}: {
    home.file.".local/share/plasma/look-and-feel/Plasma-Overdose".source = ../dots/OVERDOSE/global;
    home.file.".local/share/plasma/desktoptheme/Plasma-Overdose".source = ../dots/OVERDOSE/style;
    home.file.".icons/Plasma-Overdose".source = ../dots/OVERDOSE/cursors;
